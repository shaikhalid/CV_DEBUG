...
public class TestBase {
    ...
    private static final String BROWSERSTACK_HUB_URL = "https://hub.lambdatest.com/wd/hub";
    ...
    public void setUp(@Optional("on-prem") String environment, @Optional("single") String testType, @Optional("0") int env_cap_id, Method m) throws Exception {
        ...
        if (environment.equalsIgnoreCase("on-prem")) {
            ...
            driver.set(new RemoteWebDriver(new URL("https://" + "khalidstewards" + ":" + "X6hVXSVBrnNtSn9Wm27YwzQsCf8tyQGTGtRo6b9kL8SYuMGz8o" + "@hub.lambdatest.com/wd/hub"), caps));
